...
=======
    ...
    constructor(map: MapArray, mapConfigData: ConfigData) {
        ...
        this.enginePower = 0.083        // forward acceleration force
        this.brakingFactor = -1.5         // backwards acceleration force
    ...
    applyFriction() {
        ...
        // console.log("DRAG vel: " + this.velocity.getX() + ", " + this.velocity.getY() + ")")
        // console.log("DRAG vel mag: " + this.velocity.getMagnitude())
        let dragForce = Vector.multiplyScalar(this.velocity, this.velocity.getMagnitude())
        //console.log("DRAG force: " + dragForce.getX() + ", " + dragForce.getY() + ")")
    ...
    calculateSteering() {
        ...
        if (d > 0) {
            ...
            this.velocity = Vector.multiplyScalar(this.headingVector, this.velocity.getMagnitude())
            ...
            console.log("reverse mag: " + this.velocity.getMagnitude())
